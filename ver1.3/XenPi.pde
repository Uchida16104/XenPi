...
void setup() {
  ...
  hatname = new ControlP5(this);
  hatvol1 = new ControlP5(this);
  hatvol2 = new ControlP5(this);
  hatvol3 = new ControlP5(this);
  hatvol4 = new ControlP5(this);
  hatvol5 = new ControlP5(this);
  hatvol6 = new ControlP5(this);
  hatvol7 = new ControlP5(this);
  hatvol8 = new ControlP5(this);
  ...
  channel = new ControlP5(this);
  value = new ControlP5(this);
  sleep = new ControlP5(this);
  hydra = new ControlP5(this);
  font = parseInt("0");
  String[] fontList; 
  fontList = PFont.list();
  font1 = createFont(fontList[font],parseInt("36"),true);
  font2 = createFont(fontList[font],parseInt("18"),true);
  font3 = createFont(fontList[font],parseInt("12"),true);
  font4 = createFont(fontList[font],parseInt("15"),true);
  ...
  name4.addTextlabel("snare").setText("snare").setFont(font3)
    .setPosition(850,200);
  name5.addTextlabel("hat").setText("hat").setFont(font3)
    .setPosition(850,340);
  ...
  name8.addTextlabel("loop").setText("loop").setFont(font3)
    .setPosition(850,480);
  name9.addTextlabel("midi control").setText("midi control").setFont(font3)
    .setPosition(410,340);
  hydra.addTextlabel("hydra").setText("Please press any place, then opens hydra, and can create a session.").setFont(font4)
    .setPosition(10,35);
...
void draw() {
  ...
  msg.add(hatname.getValue("tone"));
  msg.add(hatvol1.getValue("1"));
  msg.add(hatvol2.getValue("2"));
  msg.add(hatvol3.getValue("3"));
  msg.add(hatvol4.getValue("4"));
  msg.add(hatvol5.getValue("5"));
  msg.add(hatvol6.getValue("6"));
  msg.add(hatvol7.getValue("7"));
  msg.add(hatvol8.getValue("8"));
  ...
  msg.add(channel.getValue("channel"));
  msg.add(value.getValue("value"));
  msg.add(sleep.getValue("sleep"));
  oscP5.send(msg, SonicPi);
}
void mousePressed(){
  link("https://hydra.ojack.xyz/?sketch_id=huLcnRXLGXiKi3H2");
}
