...
live_loop :synth1 do
  ...
  microtone1=hz_to_midi(midi_to_hz(hz_to_midi(connect[92])-9)*2**(connect[8]/connect[7].to_f))
  use_bpm connect[15]
  ...
  with_fx fx_names[connect[16]] , mix: connect[17] do
    if connect[14]==0 then
      ...
      midi_note_on microtone1 , connect[1] / 2.0 , channel: 1
      sleep connect[13]
      ...
      midi_note_on (chord microtone1 , chord_names[connect[9]]) , connect[1] / 2.0 , channel: 1
...
live_loop :synth2 do
  use_real_time
  connect=sync "/osc*/xenpi/synth"
  microtone2=hz_to_midi(midi_to_hz(hz_to_midi(connect[93])-9)*2**(connect[26]/connect[25].to_f))
  use_bpm connect[15]
  ...
  with_fx fx_names[connect[33]] , mix: connect[34] do
    if connect[32]==0 then
      ...
      midi_note_on microtone2 , connect[19] / 2.0 , channel: 2
      sleep connect[31]
      ...
      midi_note_on (chord microtone2 , chord_names[connect[27]]) , connect[19] / 2.0 , channel: 2
...
live_loop :synth3 do
  ...
  connect=sync "/osc*/xenpi/synth"
  use_bpm connect[15]
  microtone3=hz_to_midi(midi_to_hz(hz_to_midi(connect[97])-9)*2**(connect[99]/connect[98].to_f))
  microtone4=hz_to_midi(midi_to_hz(hz_to_midi(connect[100])-9)*2**(connect[102]/connect[101].to_f))
  ...
  with_fx fx_names[connect[103]] , mix: connect[104] do
    if connect[105]==0 then
      ...
      bend=play microtone3 , amp: connect[119] , pan: connect[120] , release: connect[108]*4 , note_slide: connect[108]
      midi_note_on microtone3 , connect[119] / 2.0 , channel: 3
      sleep connect[108]
      control bend , note: microtone4
    elsif connect[105]==1 then
      use_synth synth_names[connect[106]]
      bend=play (chord microtone3 , chord_names[connect[107]]) , amp: connect[119] , pan: connect[120] , release: connect[108]*4 , note_slide: connect[108]
      midi_note_on (chord microtone3 , chord_names[connect[107]]) , connect[119] / 2.0 , channel: 3
      ...
      use_synth synth_names[connect[106]]
      bend=play (chord microtone3 , chord_names[connect[107]]).tick , amp: connect[119] , pan: connect[120] , release: connect[108]*4 , note_slide: connect[108]
      midi_note_on (chord microtone3 , chord_names[connect[107]]).tick , connect[119] / 2.0 , channel: 3
      puts chord_names[connect[107]]
      sleep connect[108]
